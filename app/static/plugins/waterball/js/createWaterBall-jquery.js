         ...
         return this.each(function(){
            ...
            var $this = $(this),
                ...
                _config = {
                    ...
                    circle_line_color:['#4ed752','#ffa200','#fe3702'],//不同临界值圆圈线条颜色
                    main_backcolor_range:[['#2ed351','#8ced6c'],['#ffb30c','#f7d35a'],['#fe5e21','#f98957']],//渐变色
                    backcolor_range:[['#43ea83','#12ce55'],['#f4d672','#ffb50d'],['#f76b3b','#f14f17']]
                };
            if (!data) {
